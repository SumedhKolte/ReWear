...
const ProductDetailPage = () => {
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      {/* Header - Moved outside and positioned correctly */}
      <Header isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} />
      
      {/* Main Content */}
      <div className="pt-6 pb-10 px-3 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-6">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-4">
                <button className="bg-gradient-to-r from-green-600 to-emerald-500 text-white px-6 py-3 rounded-xl font-semibold hover:from-green-700 hover:to-emerald-600 transition flex items-center justify-center gap-2">
                  <RefreshCw className="h-5 w-5" /> Swap Request
                </button>
                <button className="border-2 border-orange-600 text-orange-600 px-6 py-3 rounded-xl font-semibold hover:bg-orange-50 transition flex items-center justify-center gap-2">
                  <ShoppingBag className="h-5 w-5" /> Redeem via Points
                </button>
                <button className="bg-white border border-stone-300 text-stone-600 p-3 rounded-full hover:bg-orange-50 transition self-center sm:self-start">
        ...
        <div className="max-w-5xl mx-auto mt-12">
          <h3 className="text-lg font-bold text-stone-800 mb-4">
            Previous Listings by {product.uploader.name}
          </h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
            {previousListings.map((item) => (
              <div key={item.id} className="bg-white rounded-xl shadow hover:shadow-lg transition overflow-hidden group cursor-pointer">
